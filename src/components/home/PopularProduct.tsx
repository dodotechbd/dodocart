  ...
  return (
    <div id="default-carousel" data-carousel="slide">
      <div className="lg:flex mx-auto my-10 relative h-[38rem] overflow-hidden rounded-lg">
        <div className="mb-5" data-carousel-item>
        ...
        <div className=" bg-[#F9F9F9] overflow-hidden" data-carousel-item>
          <div>
        ...
        <div className=" bg-[#EAEAEA]" data-carousel-item>
          <div>
        ...
        <div className="py-5 bg-[#2C2C2C] text-white overflow-hidden" data-carousel-item>
          <div>
